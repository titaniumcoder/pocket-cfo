...
func TestVectorTheMinimumWageBinding(t *testing.T) {
	p := bulgariaBands()
	v := p.breakdown(300, 0, 1, p.rulesFor(yearMonth{2026, time.July}))
...
func TestVectorZeroedPeriod(t *testing.T) {
	...
	v := p.breakdown(5000, 0, 1, p.rulesFor(yearMonth{2026, time.March}))
