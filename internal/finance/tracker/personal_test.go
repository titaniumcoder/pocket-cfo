...
func TestBreakdownCappedSalary(t *testing.T) {
	...
	v := p.breakdown(10000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
...
func TestBreakdownYearScalesByTwelve(t *testing.T) {
	...
	month := p.breakdown(10000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	year := p.breakdown(120000, 0, 12, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend) // same €10,000/month smoothed over a year
...
func TestBreakdownBelowCap(t *testing.T) {
	...
	v := p.breakdown(1000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
...
func TestBreakdownZeroIncome(t *testing.T) {
	...
	v := p.breakdown(0, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
...
func TestBreakdownCompanyExpensesDeductedFirst(t *testing.T) {
	...
	withExpenses := p.breakdown(1000, 200, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	equivalent := p.breakdown(800, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
...
func TestBreakdownCompanyExpensesExceedingIncomeFloorsAtZero(t *testing.T) {
	p := params()
	v := p.breakdown(500, 2000, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	if v.GrossSalaryCents != 0 || v.EmployerContribCents != 0 || v.NetIncomeCents != 0 {
...
func TestBreakdownMonthsHandlesMixedYear(t *testing.T) {
	...
	empty := p.breakdown(0, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	low := p.breakdown(1000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	belowCap := p.breakdown(3000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	aboveCap := p.breakdown(10000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
...
func TestBreakdownMonthsAppliesPerMonthCompanyExpenses(t *testing.T) {
	...
	m1 := p.breakdown(1000, 200, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	m2 := p.breakdown(1000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
	m3 := p.breakdown(1000, 0, 1, p.rulesFor(testMonth), SalaryDecision{Mode: SalaryFull}, companyStock{}, noDividend)
