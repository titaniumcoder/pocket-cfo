...
<main>
  ...
  <section class="panel budget-panel">
    ...
    <div class="ledger{{if .ShowActuals}} with-actuals{{end}}">
      ...
      {{if .ShortfallCents}}<div class="row"><span class="stale-note">The minimum salary and its employer contributions come to {{eur .ShortfallCents}} more than this period earned. That has to come from somewhere else &mdash; it is owed either way.</span></div>{{end}}
